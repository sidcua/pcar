<header>
    <nav class="navbar fixed-top navbar-expand-lg navbar-dark primary-color">
        ...
        <a class="navbar-brand" href="../" style="margin-left: -10px;"><strong>CHED PCAR - <?php if($_SESSION['level'] == 0){echo "Developer";} else if($_SESSION['level'] == 1){echo "Central";} else if($_SESSION['level'] == 2){echo "Regional Admin";} else if($_SESSION['level'] == 3){echo "Personnel";} else if($_SESSION['level'] == 4){ echo "Regional Director";}?></strong></a>
