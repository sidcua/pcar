    ...
    <div class="modal-dialog modal-sm modal-notify modal-danger" role="document">
        ...
        <div class="modal-content text-center">
            ...
            <div class="modal-footer flex-center">
                <button onclick="deletemilestone()" type="button" class="btn btn-outline-secondary-modal">Yes</button>
...
<div class="modal fade" id="modaleditmilestone" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-notify modal-warning" role="document">
        ...
        <div class="modal-content">
            ...
            <!--Footer-->
            <div class="modal-footer justify-content-center">
                <button type="button" class="btn btn-primary-modal" onclick="editmilestone()">Add</button>
