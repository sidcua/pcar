<header>
    <nav class="navbar fixed-top navbar-expand-lg navbar-dark primary-color">
        ...
        <a class="navbar-brand" href="." style="margin-left: -10px;"><strong>CHED OPCARS - <?php echo $_SESSION['region_code']; ?> (Personnel)</strong></a>
            ...
            <ul class="navbar-nav nav-flex-icons ml-auto">
                ...
                <li class="nav-item dropdown">
                    ...
                    <div class="dropdown-menu dropdown-menu-right dropdown-primary" aria-labelledby="navbarDropdownMenuLink"> 
                        ...
                        <!-- <a class="dropdown-item" href="./ipcr.php"><i class="fa fa-area-chart" aria-hidden="true"></i> IPCR <span class="sr-only"></span></a> -->
                    </div>
                </li>
                <li class="nav-item dropdown">
