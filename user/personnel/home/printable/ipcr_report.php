<?php
    ...
    //level 1
    $sql = mysql_query("SELECT program.programID, title, program.status FROM program INNER JOIN assign ON program.programID = assign.programID INNER JOIN account ON assign.accID = account.accID WHERE level = 1 AND state = 1 AND reportID = 2 AND assign.accID = '$accid'");
    while($fetch = mysql_fetch_assoc($sql)){
        ...
        $output .= '</tr>';
        //level 2
        $sql2 = mysql_query("SELECT program.programID, title, program.status FROM program INNER JOIN assign ON program.programID = assign.programID INNER JOIN account ON assign.accID = account.accID WHERE under = '$programid' AND state = 1 AND assign.accID = '$accid'");
        if(mysql_num_rows($sql2) != 0){
            while($fetch2 = mysql_fetch_assoc($sql2)){
                ...
                $output .= '</tr>';
                //level 3
                $sql3 = mysql_query("SELECT program.programID, title, program.status FROM program INNER JOIN assign ON program.programID = assign.programID INNER JOIN account ON assign.accID = account.accID WHERE under = '$programid' AND state = 1 AND assign.accID = '$accid'");
                if(mysql_num_rows($sql3) != 0){
                    while($fetch3 = mysql_fetch_assoc($sql3)){
                        ...
                        $output .= '</tr>';
                        //level 4
                        $sql4 = mysql_query("SELECT program.programID, title, program.status FROM program INNER JOIN assign ON program.programID = assign.programID INNER JOIN account ON assign.accID = account.accID WHERE under = '$programid' AND state = 1 AND assign.accID = '$accid'");
                        if(mysql_num_rows($sql4) != 0){
                            while($fetch4 = mysql_fetch_assoc($sql4)){
                                ...
                                $output .= '</tr>';
                                //level 5
                                $sql5 = mysql_query("SELECT program.programID, title, program.status FROM program INNER JOIN assign ON program.programID = assign.programID INNER JOIN account ON assign.accID = account.accID WHERE under = '$programid' AND state = 1 AND asign.accID = '$accid'");
                                if(mysql_num_rows($sql5) != 0){
                                    while($fetch5 = mysql_fetch_assoc($sql5)){
                                        ...
                                        $output .= '</tr>';
                                        //level 6
                                        $sql6 = mysql_query("SELECT program.programID, title, program.status FROM program INNER JOIN assign ON program.programID = assign.programID INNER JOIN account ON assign.accID = account.accID WHERE under = '$programid' AND state = 1 AND assign.accID = '$accid'");
    ...
    <div class="row">
        <table class="table table-bordered">
            ...
            <tbody>';
    $sql = mysql_query("SELECT DISTINCT(account.accID), name FROM account INNER JOIN milestone ON account.accID = milestone.accID WHERE reportID = 2 AND year = '$year' AND account.accID = '$accid'".$sub);
