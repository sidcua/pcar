<?php
    ...
    $sql = mysql_query("SELECT program.programID, title, status FROM program INNER JOIN assign ON program.programID = assign.programID WHERE level = 1 AND state = 1 AND reportID = 3 AND accID = '$accid'");
                ...
                <table class="table table-striped">
                    <thead class="mdb-color darken-3 table-striped">
                        <tr class="white-text text-center">
                            <th rowspan="2" style="width: 23%">Particulars</th>
                            <th rowspan="2" style="width: 10px;">UAC S COD</th>
                            <th colspan="5">Physical Targets</th>
                            <th colspan="5">Physical Accomplishments</th>
                            <th rowspan="2" style="width: 20px;">Variance</th>
