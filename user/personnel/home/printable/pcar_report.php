<?php
    ...
    $sql = mysql_query("SELECT program.programID, title, program.status FROM program INNER JOIN assign ON program.programID = assign.programID INNER JOIN account ON assign.accID = account.accID WHERE level = 1 AND state = 1 AND reportID = 1 AND assign.accID = '$accid'");
    while($fetch = mysql_fetch_assoc($sql)){
        ...
        if($status == 0){
            ...
            <td class="text-center number-font blue-text">'.$accom_total.'</td>
            <td></td>';
        }
        $output .= '</tr>';
        //level 2
        $sql2 = mysql_query("SELECT program.programID, title, program.status FROM program INNER JOIN assign ON program.programID = assign.programID INNER JOIN account ON assign.accID = account.accID WHERE under = '$programid' AND state = 1 AND account.accID = '$accid'");
        if(mysql_num_rows($sql2) != 0){
            while($fetch2 = mysql_fetch_assoc($sql2)){
                ...
                $output .= '</tr>';
                //level 3
                $sql3 = mysql_query("SELECT program.programID, title, program.status FROM program INNER JOIN assign ON program.programID = assign.programID INNER JOIN account ON assign.accID = account.accID WHERE under = '$programid' AND state = 1 AND account.accID = '$accid'");
                if(mysql_num_rows($sql3) != 0){
                    while($fetch3 = mysql_fetch_assoc($sql3)){
                        ...
                        $output .= '</tr>';
                        //level 4
                        $sql4 = mysql_query("SELECT program.programID, title, program.status FROM program INNER JOIN assign ON program.programID = assign.programID INNER JOIN account ON assign.accID = account.accID WHERE under = '$programid' AND state = 1 AND account.accID = '$accid'");
                        if(mysql_num_rows($sql4) != 0){
                            while($fetch4 = mysql_fetch_assoc($sql4)){
                                ...
                                $output .= '</tr>';
                                //level 5
                                $sql5 = mysql_query("SELECT program.programID, title, program.status FROM program INNER JOIN assign ON program.programID = assign.programID INNER JOIN account ON assign.accID = account.accID WHERE under = '$programid' AND state = 1 AND account.accID = '$accid'");
                                if(mysql_num_rows($sql5) != 0){
                                    while($fetch5 = mysql_fetch_assoc($sql5)){
                                        ...
                                        $output .= '</tr>';
                                        //level 6
                                        $sql6 = mysql_query("SELECT program.programID, title, program.status FROM program INNER JOIN assign ON program.programID = assign.programID INNER JOIN account ON assign.accID = account.accID WHERE under = '$programid' AND state = 1 AND account.accID = '$accid'");
                ...
                <table class="table table-striped">
                    <thead class="mdb-color darken-3 table-striped">
                        <tr class="white-text text-center">
                            ...
                            <th rowspan="2" style="width: 10px;">Total Targets</th>
                            <th colspan="4">Quarterly Targets</th>
                            <th colspan="4">Quarterly Accomplishments</th>
                            <th rowspan="2" style="width: 10px;">Total Accomplishmnets</th>
