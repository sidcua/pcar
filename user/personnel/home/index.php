		...
		<div class="container">
            ...
            <div class="row">
                <div class="col-sm-12" id="personalpraph_quarter">
                    <label for="targetaccomplish_quarter" class="h1-responsive"><i class="fa fa-user" aria-hidden="true"></i> <span class="display-graph">PCAR</span> Quarterly Graph - Personal</label>
