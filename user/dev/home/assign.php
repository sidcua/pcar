	...
	<body class="grey lighten-4">
			...
			<div class="row">
				<div class="col-sm-12">
					<div class="jumbotron grey lighten-5">
					    <h1 class="h1-responsive">Assigns</h1>
					    <hr class="my-2">
					    <p><i>Assigned Personnel on every program</i></p>
					</div>
				</div>
			</div>
		</div>
		<div class="container-fluid">
				...
				<div class="col-sm-10">
					<div class="d-flex flex-row">
                        <div class="form-group d-flex flex-row">
                            <?php
                                if($_SESSION['level'] < 2){
                                    echo '<label for="slctregion" style="margin: 10px 15px 0px 0px;">Region</label>
                                    <select onchange="listassign(this.value);" class="form-control" id="slctregion">
                                    </select>';
                                }
                                else{
                                    echo '<select class="form-control" id="slctregion" hidden>
                                    <option>'.$_SESSION['region'].'</option>
                                    </select>';
                                }
                            ?>
                        </div>
						<div class="form-group d-flex flex-row" style="margin-left: 20px;">
                            ...
                            <select onchange="listassign(this.value);" class="form-control" id="slctreport">
                            </select>
                        </div>
                    </div>
				</div>
			...
			<div class="row">
				...
				<table id="tblassign" class="table table-striped">
